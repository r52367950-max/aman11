      ...
      <div className="container-aman py-16">
        <div className="max-w-4xl mx-auto prose prose-lg">
          <section className="mb-12">
            <h2 className="text-2xl font-serif text-[#1A1A1A] mb-4">Introduction</h2>
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-serif text-[#1A1A1A] mb-4">Information We Collect</h2>
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-serif text-[#1A1A1A] mb-4">How We Use Your Information</h2>
            <p className="text-[#6B6B6B] leading-relaxed mb-4">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-serif text-[#1A1A1A] mb-4">Information Sharing</h2>
            <p className="text-[#6B6B6B] leading-relaxed">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-serif text-[#1A1A1A] mb-4">Your Rights</h2>
            <p className="text-[#6B6B6B] leading-relaxed mb-4">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-serif text-[#1A1A1A] mb-4">Contact Us</h2>
            <p className="text-[#6B6B6B] leading-relaxed">
