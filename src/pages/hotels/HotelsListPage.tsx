    ...
    return (
      ...
      >
        ...
        <div className="flex flex-col justify-center flex-1">
          ...
          <h3 className="text-2xl font-serif font-light text-[#1A1A1A] group-hover:text-[#C9A962] transition-colors mb-3">
            {hotel.name}
          </h3>
    ...
    >
      ...
      >
        ...
        <div className="p-6">
          ...
          <h3 className="text-xl font-serif font-light text-[#1A1A1A] group-hover:text-[#C9A962] transition-colors mb-2">
            {hotel.name}
          </h3>
