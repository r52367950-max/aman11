        ...
        <div className="max-w-3xl mx-auto">
          ...
          >
            ...
            <div className="bg-[#F5F0E8] p-6 mb-8">
              <h3 className="text-lg font-serif font-light text-[#1A1A1A] mb-4">Price Breakdown</h3>
          ...
          >
            <h3 className="text-xl font-serif font-light text-[#1A1A1A] mb-4">What's Next?</h3>
