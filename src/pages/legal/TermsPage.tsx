      ...
      <div className="container-aman py-16">
        <div className="max-w-4xl mx-auto prose prose-lg">
          <section className="mb-12">
            <h2 className="text-2xl font-serif font-light text-[#1A1A1A] mb-4">Acceptance of Terms</h2>
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-serif font-light text-[#1A1A1A] mb-4">Use of Website</h2>
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-serif font-light text-[#1A1A1A] mb-4">Reservations and Bookings</h2>
            <p className="text-[#6B6B6B] leading-relaxed">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-serif font-light text-[#1A1A1A] mb-4">Intellectual Property</h2>
            <p className="text-[#6B6B6B] leading-relaxed">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-serif font-light text-[#1A1A1A] mb-4">Disclaimer</h2>
            <p className="text-[#6B6B6B] leading-relaxed">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-serif font-light text-[#1A1A1A] mb-4">Limitation of Liability</h2>
            <p className="text-[#6B6B6B] leading-relaxed">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-serif font-light text-[#1A1A1A] mb-4">Governing Law</h2>
            <p className="text-[#6B6B6B] leading-relaxed">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-serif font-light text-[#1A1A1A] mb-4">Changes to Terms</h2>
            <p className="text-[#6B6B6B] leading-relaxed">
