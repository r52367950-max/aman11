    ...
    <div className="min-h-screen bg-[#F5F0E8] pt-20">
      ...
      <div className="container-aman py-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-5xl mx-auto">
          ...
          <div>
            ...
            >
              ...
              <div>
                ...
                <p className="text-5xl font-serif font-light">${finalAmount.toLocaleString()}</p>
              </div>
            ...
            <div className="mt-8 bg-white border border-[#E5E0D8] p-6">
              <h3 className="text-lg font-serif font-light text-[#1A1A1A] mb-4">Gift Card Details</h3>
          ...
          {/* Purchase Form */}
          <div>
            <h2 className="text-2xl font-serif font-light text-[#1A1A1A] mb-6">Purchase Gift Card</h2>
            ...
            <div className="space-y-4 mb-8">
              <h3 className="text-lg font-serif font-light text-[#1A1A1A]">Your Details</h3>
              <input
                type="text"
