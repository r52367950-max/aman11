          ...
          {shopCategories.map((category, index) => (
            ...
            >
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center text-white">
                <h3 className="text-xl font-serif font-light">{category.name}</h3>
            ...
            >
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <h3 className="text-lg font-serif font-light text-[#1A1A1A] group-hover:text-[#C9A962] transition-colors">
                    {product.name}
                  </h3>
