        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-16">
            <section className="animate-in opacity-0">
              <h2 className="text-3xl font-serif font-light text-[#1A1A1A] mb-6">The Beginning</h2>
            ...
            <section className="animate-in opacity-0">
              <h2 className="text-3xl font-serif font-light text-[#1A1A1A] mb-6">The Aman Philosophy</h2>
              <p className="text-[#6B6B6B] leading-relaxed mb-4">
            ...
            <section className="animate-in opacity-0">
              <h2 className="text-3xl font-serif font-light text-[#1A1A1A] mb-6">Growing the Family</h2>
              <p className="text-[#6B6B6B] leading-relaxed mb-4">
            ...
            <section className="animate-in opacity-0">
              <h2 className="text-3xl font-serif font-light text-[#1A1A1A] mb-6">Looking Forward</h2>
              <p className="text-[#6B6B6B] leading-relaxed mb-4">
