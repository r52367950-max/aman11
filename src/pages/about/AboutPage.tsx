        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mt-20">
          {stats.map((stat, index) => (
            ...
            >
              ...
              <p className="text-4xl font-serif font-light text-[#1A1A1A] mb-2">{stat.value}</p>
          ...
          {[
            ...
            >
              <div className="w-24 flex-shrink-0 text-right">
                <span className="text-2xl font-serif font-light text-[#C9A962]">{milestone.year}</span>
              </div>
              <div className="w-px h-full bg-[#E5E0D8] relative">
                <div className="absolute top-0 left-1/2 -translate-x-1/2 w-3 h-3 bg-[#C9A962]" />
              </div>
              <div className="flex-1 pb-8">
                <h3 className="text-xl font-serif font-light text-[#1A1A1A] mb-2">{milestone.title}</h3>
      ...
      <div className="bg-[#F5F0E8] border-t border-[#E5E0D8] py-16">
        <div className="container-aman">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            <div>
              <h3 className="text-2xl md:text-3xl font-serif font-light text-[#1A1A1A] mb-2">
