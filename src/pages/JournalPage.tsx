        ...
        <Link to={`/journal/${featuredArticle.slug}`} className="group block">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="flex flex-col justify-center">
              ...
              <h2 className="text-3xl md:text-4xl font-serif font-light text-[#1A1A1A] group-hover:text-[#C9A962] transition-colors mb-4">
          ...
          {filteredArticles.slice(1).map((article, index) => (
            ...
            >
              ...
              >
                ...
                <h3 className="text-xl font-serif font-light text-[#1A1A1A] group-hover:text-[#C9A962] transition-colors mt-2 mb-2">
                  {article.title}
                </h3>
