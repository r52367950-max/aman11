        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-1">
            <div className="space-y-8">
              <div>
                ...
                <h3 className="text-lg font-serif text-[#1A1A1A] mb-2">Phone</h3>
              ...
              <div>
                ...
                <h3 className="text-lg font-serif text-[#1A1A1A] mb-2">Email</h3>
              ...
              <div>
                ...
                <h3 className="text-lg font-serif text-[#1A1A1A] mb-2">Headquarters</h3>
              ...
              <div>
                ...
                <h3 className="text-lg font-serif text-[#1A1A1A] mb-2">Hours</h3>
          ...
          <div className="lg:col-span-2">
            <div className="bg-white border border-[#E5E0D8] p-8">
              <h2 className="text-2xl font-serif text-[#1A1A1A] mb-6">Send Us a Message</h2>
