        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <form onSubmit={handleSubmit} className="bg-white border border-[#E5E0D8] p-8">
              {step === 1 && (
                <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
                  <h2 className="text-2xl font-serif text-[#1A1A1A] mb-6">Contact Information</h2>
              ...
              {step === 2 && (
                <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
                  <h2 className="text-2xl font-serif text-[#1A1A1A] mb-6">Shipping Method</h2>
                  <div className="space-y-4">
                    {[
              ...
              {step === 3 && (
                <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
                  <h2 className="text-2xl font-serif text-[#1A1A1A] mb-6">Payment</h2>
                  <div className="space-y-4">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white border border-[#E5E0D8] p-6 sticky top-24">
              <h3 className="text-lg font-serif text-[#1A1A1A] mb-6">Order Summary</h3>
