  ...
  if (!hotel) {
    return (
      <div className="min-h-screen bg-[#F5F0E8] pt-32 text-center">
        <h1 className="text-3xl font-serif text-[#1A1A1A]">Hotel not found</h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2 space-y-12">
              ...
              <section className="animate-in opacity-0">
                <h2 className="text-2xl font-serif text-[#1A1A1A] mb-4">About</h2>
              ...
              {/* Amenities */}
              <section className="animate-in opacity-0">
                <h2 className="text-2xl font-serif text-[#1A1A1A] mb-4">Amenities</h2>
              ...
              {/* Location */}
              <section className="animate-in opacity-0">
                <h2 className="text-2xl font-serif text-[#1A1A1A] mb-4">Location</h2>
              ...
              {/* Reviews */}
              <section className="animate-in opacity-0">
                <h2 className="text-2xl font-serif text-[#1A1A1A] mb-4">Guest Reviews</h2>
                <div className="space-y-6">
                  {hotel.reviews.map((review) => (
                    <div key={review.id} className="bg-white border border-[#E5E0D8] p-6">
                      <div className="flex items-center justify-between mb-3">
                        <div className="flex items-center gap-2">
                          <div className="w-10 h-10 bg-[#F5F0E8] flex items-center justify-center text-[#C9A962] font-serif">
                            {review.author[0]}
                          </div>
                          <div>
            ...
            <div className="lg:col-span-1">
              <div className="sticky top-40 bg-white border border-[#E5E0D8] p-6">
                <h3 className="text-xl font-serif text-[#1A1A1A] mb-4">Book Your Stay</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {hotel.rooms.map((room) => (
              <div key={room.id} className="animate-in opacity-0 bg-white border border-[#E5E0D8] overflow-hidden">
                ...
                <div className="p-6">
                  <h3 className="text-xl font-serif text-[#1A1A1A] mb-2">{room.name}</h3>
            ...
            {hotel.dining.map((restaurant) => (
              <div key={restaurant.id} className="animate-in opacity-0 grid grid-cols-1 md:grid-cols-2 gap-6 bg-white border border-[#E5E0D8] overflow-hidden">
                ...
                <div className="p-6 flex flex-col justify-center">
                  ...
                  <h3 className="text-2xl font-serif text-[#1A1A1A] mb-3">{restaurant.name}</h3>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 space-y-8">
              <div className="animate-in opacity-0">
                <h2 className="text-2xl font-serif text-[#1A1A1A] mb-4">{hotel.spa.name}</h2>
                <p className="text-[#6B6B6B] leading-relaxed">{hotel.spa.description}</p>
              </div>

              <div className="animate-in opacity-0">
                <h3 className="text-xl font-serif text-[#1A1A1A] mb-4">Treatments</h3>
                <div className="space-y-4">
            ...
            <div className="animate-in opacity-0">
              <div className="bg-[#F5F0E8] p-6">
                <h3 className="text-lg font-serif text-[#1A1A1A] mb-4">Facilities</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {hotel.experiences.map((experience) => (
              <div key={experience.id} className="animate-in opacity-0 bg-white border border-[#E5E0D8] overflow-hidden group">
                ...
                <div className="p-6">
                  <h3 className="text-xl font-serif text-[#1A1A1A] mb-2 group-hover:text-[#C9A962] transition-colors">{experience.name}</h3>
