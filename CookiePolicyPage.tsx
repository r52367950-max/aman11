      ...
      <div className="container-aman py-16">
        <div className="max-w-4xl mx-auto prose prose-lg">
          <section className="mb-12">
            <h2 className="text-2xl font-serif text-[#1A1A1A] mb-4">What Are Cookies</h2>
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-serif text-[#1A1A1A] mb-4">How We Use Cookies</h2>
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-serif text-[#1A1A1A] mb-4">Types of Cookies We Use</h2>
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-serif text-[#1A1A1A] mb-4">Managing Cookies</h2>
            <p className="text-[#6B6B6B] leading-relaxed">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-serif text-[#1A1A1A] mb-4">Cookie Consent</h2>
            <p className="text-[#6B6B6B] leading-relaxed">
