  ...
  if (!experience) {
    return (
      <div className="min-h-screen bg-[#F5F0E8] pt-32 text-center">
        <h1 className="text-3xl font-serif text-[#1A1A1A]">Experience not found</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2 space-y-12">
            ...
            <section className="animate-in opacity-0">
              <h2 className="text-2xl font-serif text-[#1A1A1A] mb-4">Experience Overview</h2>
            ...
            {/* Highlights */}
            <section className="animate-in opacity-0">
              <h2 className="text-2xl font-serif text-[#1A1A1A] mb-4">Highlights</h2>
            ...
            {/* Itinerary */}
            <section className="animate-in opacity-0">
              <h2 className="text-2xl font-serif text-[#1A1A1A] mb-4">Itinerary</h2>
            ...
            <section className="animate-in opacity-0 grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                <h3 className="text-lg font-serif text-[#1A1A1A] mb-4">What's Included</h3>
              ...
              <div>
                <h3 className="text-lg font-serif text-[#1A1A1A] mb-4">Not Included</h3>
                <ul className="space-y-2">
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-40 space-y-6">
              ...
              <div className="bg-white border border-[#E5E0D8] p-6">
                <h3 className="text-lg font-serif text-[#1A1A1A] mb-4">Experience Details</h3>
                <div className="space-y-4">
              ...
              <div className="bg-[#1A1A1A] p-6 text-white">
                <h3 className="text-lg font-serif mb-4">Book This Experience</h3>
              ...
              <div className="bg-[#F5F0E8] p-6">
                <h3 className="text-lg font-serif text-[#1A1A1A] mb-4">Requirements</h3>
                <ul className="space-y-2">
      ...
      <AnimatePresence>
        {showBookingModal && (
          ...
          >
            ...
            >
              <h3 className="text-2xl font-serif text-[#1A1A1A] mb-4">Book {experience.name}</h3>
