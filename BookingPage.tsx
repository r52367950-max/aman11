        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            {currentStep === 0 && (
              ...
              >
                <h2 className="text-2xl font-serif text-[#1A1A1A] mb-6">Select Your Dates</h2>
            ...
            {currentStep === 1 && hotel && (
              ...
              >
                <h2 className="text-2xl font-serif text-[#1A1A1A]">Select Your Room</h2>
                    ...
                    <div className="flex flex-col md:flex-row gap-6">
                      ...
                      <div className="flex-1">
                        <div className="flex items-start justify-between">
                          <div>
                            <h3 className="text-xl font-serif text-[#1A1A1A]">{room.name}</h3>
            ...
            {currentStep === 2 && (
              <motion.div
                ...
                className="animate-in opacity-0 bg-white border border-[#E5E0D8] p-8"
              >
                <h2 className="text-2xl font-serif text-[#1A1A1A] mb-6">Guest Details</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
            ...
            {currentStep === 3 && (
              <motion.div
                ...
                className="animate-in opacity-0 bg-white border border-[#E5E0D8] p-8"
              >
                <h2 className="text-2xl font-serif text-[#1A1A1A] mb-6">Payment Details</h2>
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-40 bg-white border border-[#E5E0D8] p-6">
              <h3 className="text-lg font-serif text-[#1A1A1A] mb-4">Booking Summary</h3>
              {hotel && (
