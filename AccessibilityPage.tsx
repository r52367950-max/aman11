      ...
      <div className="container-aman py-16">
        <div className="max-w-4xl mx-auto prose prose-lg">
          <section className="mb-12">
            <h2 className="text-2xl font-serif text-[#1A1A1A] mb-4">Our Commitment</h2>
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-serif text-[#1A1A1A] mb-4">Accessibility Features</h2>
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-serif text-[#1A1A1A] mb-4">Standards Compliance</h2>
            <p className="text-[#6B6B6B] leading-relaxed">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-serif text-[#1A1A1A] mb-4">Physical Accessibility</h2>
            <p className="text-[#6B6B6B] leading-relaxed">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-serif text-[#1A1A1A] mb-4">Feedback</h2>
            <p className="text-[#6B6B6B] leading-relaxed">
