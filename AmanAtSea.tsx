        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div ref={contentRef} className="lg:pl-8">
            ...
            <div className="grid grid-cols-2 gap-6 mb-10">
              <div>
                <p className="text-3xl font-serif text-[#C9A962] mb-1">183m</p>
                <p className="text-sm text-[#9A9A9A]">Length</p>
              </div>
              <div>
                <p className="text-3xl font-serif text-[#C9A962] mb-1">50</p>
                <p className="text-sm text-[#9A9A9A]">Suites</p>
              </div>
              <div>
                <p className="text-3xl font-serif text-[#C9A962] mb-1">2026</p>
                <p className="text-sm text-[#9A9A9A]">Launch</p>
              </div>
              <div>
                <p className="text-3xl font-serif text-[#C9A962] mb-1">
                  Mediterranean
                </p>
